export default function useAnimate(canvas) {
        ...
        let styles = [
            {
                size: 2,
                style: "pattern",
                color: { h: 133, s: 100, l: 70, a: 0.1 },
            },
            {
                size: 2.5,
                style: "pattern",
                color: { h: 19, s: 100, l: 60, a: 0.3 },
            }, //kinda light orange
            {
                size: 5,
                style: "pattern",
                color: { h: 21, s: 89.8, l: 49.8, a: 0.2 },
            }, // bright orange
            {
                size: 10,
                style: "pattern",
                color: { h: 160, s: 50, l: 55, a: 0.15 },
            }, //light turquoise
            {
                size: 20,
                style: "pattern",
                color: { h: 100, s: 25, l: 35, a: 0.12 },
            }, //transparent green
            {
                size: 40,
                style: "pattern",
                color: { h: 160, s: 19.1, l: 90.8, a: 0.12 },
            }, //transparent turquoise
            {
                size: 80,
                style: "pattern",
                color: { h: 100, s: 100, l: 77, a: 0.12 },
            }, //transparent light green
            {
                size: 40,
                style: "glitches",
                color: { h: 133, s: 61, l: 33, a: 0.3 },
            },
            {
                size: 20,
                style: "glitches",
                color: { h: 18, s: 100, l: 50, a: 0.3 },
            },
            {
                size: 60,
                style: "glitches",
                color: { h: 43, s: 96, l: 89, a: 0.3 },
            },
        ];
